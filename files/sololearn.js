...
getid("form2").addEventListener("submit", function(event1){
    event1.preventDefault();
    searchcode();
});
getid("form3").addEventListener("submit", function(event2){
...
function showmeme(){
    ...
    checklink();
    if (finalmeme == 'No'){
        imgg = 'No memes available';
    } else {
        imgg = '<img class="memeimg" src="'+finalmeme+'" onload=this.style.height="auto" onerror=this.src="files/img/Noimg.png">';
    }
    return imgg;
}
